...
namespace MediaTekDocuments.controller
{
    ...
    class FrmMediatekController
    {
        ...
        {
            return access.SupprimerCmdDoc(commandesDocument);
        }
    }
}
